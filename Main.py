...
class SportsLottery(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for page in (LoginPage, NewsPage, TeamPage, PersonalPage): # StartPage：測試用，之後會換掉
...
class LoginPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.canvas=tk.Canvas(self,width=500,height=200, bg="plum2") 
        ...
        f1=tkFont.Font(size=20, family="Didot")
        self.l1=tk.Label(self.canvas, text="使用者名稱：", font=f1, bg="misty rose")
        self.l2=tk.Label(self.canvas, text="密碼：", font=f1, bg="misty rose")
        self.l1.pack(side=TOP, padx=20, pady=20)
        ...
        # 默認值
        # var_usr_name.set("")
        self.l2.pack(side=TOP,padx=20, pady=20) 
